      ...
      >
        <div className="w-full max-w-[960px] mx-auto">
          <p className="intro-paragraph reveal-text text-[clamp(20px,2.2vw,34px)] font-normal text-[#1a1a2e] leading-[1.5] tracking-[-0.01em] font-heading mx-auto text-center">
            Most marketing problems are strategy problems. Brands waste budget because they <span className="highlight text-[#2563eb] font-semibold">do not know their market</span> well enough, their messaging <span className="highlight text-[#2563eb] font-semibold">does not match what their audience cares about</span> or their campaigns <span className="highlight text-[#2563eb] font-semibold">have no clear commercial objective</span>. We fix that before the first ad runs.
          </p>
        </div>
