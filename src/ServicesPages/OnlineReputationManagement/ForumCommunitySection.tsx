      ...
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center order-2 lg:order-1">
            ...
            <div className="forum-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Star Grid with red/coral hue */}
                <img
                  src="/images/ContactStarPattern.png"
                  className="forum-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-125 z-0 opacity-70 pointer-events-none"
                  style={{ filter: "hue-rotate(330deg) saturate(3.5) brightness(0.85)" }}
                  alt="Community Star Pattern Background"
                />

                {/* Main Illustration: image 73 */}
                <img
                  src="/images/ORM/image 73.png"
                  className="forum-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.85]"
                  alt="Forum & Community Reputation Illustration"
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start order-1 lg:order-2">
            ...
            <h2 className="forum-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl font-heading font-normal">
              Authentic Presence, <br />
              Protected Authority
            </h2>

            <div className="forum-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-gray-300">
              <p>
                Stop burning ad spend on unoptimized campaigns. We build high-converting paid social campaigns by our social media marketing experts for Meta, TikTok, LinkedIn &amp; YouTube, engineered to acquire customers at scale. With targeted audience segmentation &amp; rapid creative iteration, our agency relentlessly optimizes ROAS.
              </p>
              <p>
        ...
        <div className="w-full mt-8">
          <h3 className="forum-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div
                key={idx}
                className="forum-deliverable-item service-deliverable-item flex items-start gap-2.5"
              >
...
export default ForumCommunitySection;
