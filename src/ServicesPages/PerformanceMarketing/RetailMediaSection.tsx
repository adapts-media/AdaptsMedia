      ...
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start">
            ...
            <h2 className="retail-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl font-heading font-normal">
              Sell More Where People Are Already Buying
            </h2>

            <div className="retail-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-blue-50/90">
              <p>
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="retail-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                ...
                {/* Main Illustration */}
                <img
                  src="/images/Performance Marketing Icons/image 47.png"
        ...
        <div className="w-full mt-8">
          <h3 className="retail-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
