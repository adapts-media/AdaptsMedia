      ...
      >
        <div className="w-full max-w-[960px] mx-auto">
          <p className="intro-paragraph reveal-text text-[clamp(20px,2.2vw,34px)] font-normal text-[#1a1a2e] leading-[1.5] tracking-[-0.01em] font-heading mx-auto text-center">
            Paid media without strategy is burning budget. We build <span className="highlight text-[#2563eb] font-semibold">performance-led campaigns</span> across search, social, programmatic and direct channels, combining <span className="highlight text-[#2563eb] font-semibold">precise audience targeting</span> with <span className="highlight text-[#2563eb] font-semibold">relentless optimisation</span> to drive qualified traffic, lower acquisition costs and scale what delivers returns.
          </p>
        </div>
