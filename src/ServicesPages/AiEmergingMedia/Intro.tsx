      ...
      >
        <div className="w-full max-w-[960px] mx-auto">
          <p className="intro-paragraph reveal-text text-[clamp(20px,2.2vw,34px)] font-normal text-[#1a1a2e] leading-[1.5] tracking-[-0.01em] font-heading mx-auto text-center">
            Every CMO is asking their agency the same question: what is your AI story? We have an answer that goes beyond tools and buzzwords. We are building <span className="highlight text-[#2563eb] font-semibold">AEO and GEO capabilities</span>, deploying <span className="highlight text-[#2563eb] font-semibold">agentic marketing workflows</span> and developing <span className="highlight text-[#2563eb] font-semibold">AI-native content pipelines</span> for clients. This is not a future roadmap. It is work we are doing now.
          </p>
        </div>
