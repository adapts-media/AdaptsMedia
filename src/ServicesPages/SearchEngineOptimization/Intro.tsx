      ...
      >
        <div className="w-full max-w-[960px] mx-auto">
          <p className="intro-paragraph reveal-text text-[clamp(20px,2.2vw,34px)] font-normal text-[#1a1a2e] leading-[1.5] tracking-[-0.01em] font-heading mx-auto text-center">
            SEO without technical precision and business alignment is burning resources. We build <span className="highlight text-[#2563eb] font-semibold">revenue-led organic search campaigns</span> across technical infrastructure, content architecture, authority building, and modern search ecosystems, combining <span className="highlight text-[#2563eb] font-semibold">deep search intent analysis</span> with <span className="highlight text-[#2563eb] font-semibold">continuous optimization</span> to capture high-intent traffic, lower acquisition costs, and dominate search results.
          </p>
        </div>
