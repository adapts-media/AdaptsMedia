      ...
      >
        <div className="w-full max-w-[960px] mx-auto">
          <p className="intro-paragraph reveal-text text-[clamp(20px,2.2vw,34px)] font-normal text-[#1a1a2e] leading-[1.5] tracking-[-0.01em] font-heading mx-auto text-center">
            Attention is hard to earn. Even harder to keep. Merging sharp cultural awareness with <span className="highlight text-[#2563eb] font-semibold">data-backed performance</span>, we capture mindshare across every channel, managing the <span className="highlight text-[#2563eb] font-semibold">entire lifecycle of your brand’s voice</span> from strategy and creation to community and conversion. Collaborate with us to build social &amp; content strategies designed to drive <span className="highlight text-[#2563eb] font-semibold">real revenue &amp; brand equity</span>.
          </p>
        </div>
