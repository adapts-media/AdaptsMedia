  ...
  return (
    <div className="relative min-h-screen bg-black overflow-x-hidden overflow-y-auto">
      ...
      <div className="fixed inset-0 z-0 opacity-[0.06] pointer-events-none">
        <video autoPlay loop muted playsInline suppressHydrationWarning poster="/default-og.jpg" className="w-full h-full object-cover" style={{ filter: "contrast(200%) saturate(0%)" }}>
          <source
